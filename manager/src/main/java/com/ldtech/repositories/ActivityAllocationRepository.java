...
public interface ActivityAllocationRepository extends JpaRepository<ActivityAllocation, ActivityAllocationId> {
    ...
    ActivityAllocation findByIdEmployeeIdAndIdProjectIdAndIdActivityTypeAndActivityAllocationDate(String employeeId, String projectId1, String activityType1, LocalDate logDate1);
